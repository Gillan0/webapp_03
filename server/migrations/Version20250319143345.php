 ...
 */
final class Version20250319143345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, item_from_wishlist_id INT NOT NULL, title VARCHAR(20) NOT NULL, description VARCHAR(500) NOT NULL, price DOUBLE PRECISION NOT NULL, url VARCHAR(200) NOT NULL, INDEX IDX_1F1B251E5DA366B7 (item_from_wishlist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE purchased_item (id INT AUTO_INCREMENT NOT NULL, buyer_id INT NOT NULL, congratulory_message VARCHAR(500) NOT NULL, purchase_proof VARCHAR(200) NOT NULL, INDEX IDX_F84821416C755722 (buyer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, website_id INT NOT NULL, username VARCHAR(20) NOT NULL, password VARCHAR(20) NOT NULL, email VARCHAR(50) NOT NULL, is_locked TINYINT(1) NOT NULL, INDEX IDX_8D93D64918F45C82 (website_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE wishlist (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, deadline DATE NOT NULL, name VARCHAR(20) NOT NULL, sharing_url VARCHAR(100) NOT NULL, display_url VARCHAR(100) NOT NULL, INDEX IDX_9CE12A31F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', available_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivered_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251E5DA366B7 FOREIGN KEY (item_from_wishlist_id) REFERENCES wishlist (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item DROP FOREIGN KEY FK_1F1B251E5DA366B7');
